...
---
![Director Patty Jenkins and lead actor Gal Gadot on the set of $800m blockbuster Wonder Woman. Photograph: Clay Enos](https://i.guim.co.uk/img/media/58fef77a821ebae1c088bf0bdcd36afce7e2ab88/0_265_7608_4566/master/7608.jpg?w=620&q=20&auto=format&usm=12&fit=max&dpr=2&s=9931135c53536e0fb943707bc896635c.png)

Title: Chick Flicks Are the Key to Fixing Hollywood’s Gender Diversity Problem

##How the World is Stopping Sexual Harassment in Film
  Almost daily, another prominent man in Hollywood is accused of sexual harassment. The #MeToo movement in the United States has had a profound impact, holding many powerful men accountable for their inappropriate conduct and has been [named the Times Magazine Person of the Year](http://time.com/time-person-of-the-year-2017-silence-breakers/). However, the impact of this movement has spread beyond the United States. Hollywood must look globally to determine what other actions it can take to prevent future harassment. 

  As the amount of women working in the global film industry grows, women’s voices increase in power, both onscreen and off. To create more opportunities for women in film, Hollywood must both look internally and internationally: what factors in the workplace lead to higher levels of sexual harassment, and what steps have already been taken in other countries to address this issue? To answer these questions, we examined how the percentage of women in positions of power in Hollywood has changed over time and how that percentage compares to other countries grappling with their own film industries’ inequalities. We wanted to know if the United States has higher levels of female producers and directors than other countries and how other countries responded to the #MeToo movement.
...
p4
```
  We took data from the International Movie Database, also known as IMDb. IMDb contains information about millions of pieces of media, including television, online content, and movies. We found the listed gender of the directors and producers of movies made in the United States, then grouped them by decade. Clearly, while the percentage has increased over time, women producers and directors are still a minority in their fields. With a relatively stable increase of a roughly 5% increase per decade, based on the historic rate it will take another five decades for women in leadership roles in Hollywood to reflect real life gender ratios. While we looked at a large set of movies, including lower budget films, these percentages would be even lower for big budget movies and more popular movies shown in wide release. According to the Media, Diversity, & Social Change Initiative out of USC Annenberg, as budgets increase, opportunities for female filmmakers decrease. Their data shows that from 2007-2016, women directed 28% of narrative shorts and 27% of narrative independent films, but only 4% of top-grossing films in Hollywood. Since our data encompasses all of these genres, it presents a higher proportion of female directors and producers than may be presented by other, more limited sets of data that only look at the directors for wide-release movies. Thinktanks like the Media, Diversity, & Social Change Initiative prefer to focus on such limited data sets since they are what affect the public consciousness. However, with the film industry expanding and films being produced on even more platforms, like Netflix movies and independent, internet-released movies, we felt it was important to acknowledge the opportunities female creators of all budgets have created for themselves and so therefore used a larger data set. As it gets easier to release your own content, more and more independent creators of all genders, races, and professional levels have been able to gain audiences, voices, and therefore enough clout in the film industry to speak up about sexual harassment.
...
```
  Since not every movie released in India and China is on IMDb, especially the lower-budget movies that women are more likely to direct or produce, so our data may be skewed. Even so, it is clear that the amount of female filmmakers has been increasing worldwide. 

[Krew Boylan, Rose Byrne, Jessica Carrera, Shannon Murphy and Gracie Otto, the founders of Dollhouse Pictures. Dollhouse Pictures is an Australian independent production company which prioritises female-driven storytelling.](http://www.cinemazzi.com/wp-content/uploads/2015/04/The-Dollhouse-Collective-group-image.jpg)

Despite the global growth of women in film, the movement to end sexual assault is occurring almost exclusively in countries like Australia and Canada, who share relatively similar cultures and percentages of female filmmakers as the United States. In 2015, a group of female Directors Guild members, led by Gillian Armstrong, pressured the Australian government’s public screen production fund to address the lack of female directors within Australian film. Australia [established several initiatives](https://www.if.com.au/screen-australia-reveals-gender-matters-three-tick-test/), including a “three ticks” policy, which ensured that 50% of all film projects the government backed by 2019 would have women in three of four creatives roles: producer, director, writer, or lead actor. This week, Australia announced that it was creating a sexual harassment code of practice that all film and TV companies must follow to be given government funding. A similar effort took place from 1974-1996 in Canada, where the Canadian government funded an studio which would exclusively make films by women filmmakers for and about women. It was a critical success, creating Oscar winning films about boundary-pushing social issues, but eventually ended due to lack of government funding. Australia and Canada used control of government [funds to support female filmmakers](http://time.com/5044854/hollywood-women-studio-d/), but Hollywood is almost exclusively driven by private companies. In order to take steps like Australia’s, Hollywood must promote stricter standards and financial incentives to increase its amount of female directors and producers. By doing so, women will be given the space they need to tell their stories, whether they are fictional or all too real. 
